...
excel_path = os.path.join(pasta_script, "..", "testes/fixa_eva_10pontos/pesos/media_pesos_sem_2linha.xlsx")
...
graphs_folder = os.path.join(pasta_script, "..", "testes/fixa_eva_10pontos/pesos", "graphs")
