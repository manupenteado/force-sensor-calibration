...
excel_path = os.path.join(pasta_script, "..", "testes_manu_smf_com_eva_fixa/result_smf_eva_fixo.xlsx")
...
graphs_folder = os.path.join(pasta_script, "..", "testes_manu_smf_com_eva_fixa", "graphs")
